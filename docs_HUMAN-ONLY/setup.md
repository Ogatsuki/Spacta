...
Which is also the honest warning about emptying a check rather than removing it. This is your repository and the decision is yours; what is worth knowing is that the two failure modes do not cost the same. **A law you delete is a law you know you do not have** — `verify` prints it under *"NOT verified in this project"*, with the roots it looked in, on every single run. A law left in place with nothing behind it prints under *Guaranteed by this green* and is indistinguishable from one that held. If a Law does not fit what you are building, say so out loud in the registry; the thing to avoid is not the missing check but the green that claims it ran.
