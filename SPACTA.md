...
3.  If you need aggregation at server boundaries (`page.tsx` / `route.ts` / `layout.tsx`), **write a pure function in Core and call it** (L5). Do not generate IDs/time here.
